    ...
    SubShader
    {
        ...
        {    
            ...
            float4 frag(VertexOutput input) : COLOR
            {
                ...
                float4 ambientColour = (_BelowAmbientColour * (1.0 - upness) + _AboveAmbientColour * upness);
                
                
                float4 ambientResult = float4(ambientColour * diffuseColour + float4(emissiveColour * _EmissiveStrength, 0.0));
        ...
        {    
            ...
            float4 frag(VertexOutput input) : COLOR
            {
            	...
            	//return float4 (input.posLight.xy, 0.0, 0.0);
